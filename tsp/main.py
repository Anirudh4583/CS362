...
# Get the x and y coordinates of 25 places
df = pd.read_csv("/content/drive/MyDrive/lab3/rajasthan.csv")
x = df["x"]
y = df["y"]
...
def get_data(option=1):
    ...
    if (option == 1):
        file = "/content/drive/MyDrive/lab3/xqf131.tsp"

    elif (option == 2):
        file = "/content/drive/MyDrive/lab3/xqg237.tsp"

    elif (option == 3):
        file = "/content/drive/MyDrive/lab3/pma343.tsp"
    
    elif (option == 4):
        file = "/content/drive/MyDrive/lab3/pka379.tsp"

    elif (option == 5):
        file = "/content/drive/MyDrive/lab3/bcl380.tsp"
...
# Data from VLSI (logs of computation)
